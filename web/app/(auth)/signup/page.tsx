      ...
      <div className="auth-card rounded-2xl p-8 animate-fade-in-scale">
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          >
            <input
              ...
              className="mt-1 h-4 w-4 rounded border-[#30363d] bg-[#0d1117] text-[#58a6ff] focus:ring-[#58a6ff] focus:ring-2"
              disabled={loading}
            />
            <label htmlFor="terms" className="text-sm text-[#7d8590]">
              I agree to the{' '}
              <Link href="/terms" className="text-[#58a6ff] hover:text-[#1f6feb] transition-colors">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link href="/privacy" className="text-[#58a6ff] hover:text-[#1f6feb] transition-colors">
                Privacy Policy
              </Link>
            </label>
          </motion.div>
        ...
        >
          <p className="text-[#7d8590]">
            ...
            <Link
              href="/login"
              className="text-[#58a6ff] hover:text-[#1f6feb] font-semibold transition-colors"
            >
              Sign in
            </Link>
          </p>
