    ...
    <div className="min-h-screen bg-[#08080a] text-white antialiased">
      ...
      <section className="px-6 md:px-10 pt-16 pb-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            <Link href="/auth/signup" className="px-6 py-2.5 bg-[#00e5a0] text-black text-[13px] font-bold rounded-lg hover:bg-[#00cc8e] transition-colors">
      ...
      <section className="px-6 md:px-10 py-10">
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-b from-[#00e5a0]/[0.03] to-transparent border border-[#00e5a0]/[0.08] rounded-xl p-8 text-center relative overflow-hidden">
            ...
            <Link href="/auth/signup" className="inline-block px-8 py-3 bg-[#00e5a0] text-black text-[14px] font-bold rounded-lg hover:bg-[#00cc8e] transition-colors shadow-[0_0_30px_rgba(0,229,160,.1)]">
      ...
      <section className="px-6 md:px-10 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/auth/signup" className="inline-block px-10 py-4 bg-[#00e5a0] text-black text-[15px] font-bold rounded-lg hover:bg-[#00cc8e] transition-colors shadow-[0_0_40px_rgba(0,229,160,.12)]">
